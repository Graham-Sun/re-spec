...
describe('Validate TS configs', () => {
  it('Validate eslint-config-re/typescript', async () => {
  ...
  it('Validate eslint-config-re/typescript/vue', async () => {
  ...
  it('Validate eslint-config-re/essential/typescript', async () => {
  ...
  it('Validate eslint-config-re/essential/typescript/react', async () => {
  ...
  it('Validate eslint-config-re/essential/typescript/vue', async () => {
  ...
  it('Validate eslint-config-re/typescript/node', async () => {
