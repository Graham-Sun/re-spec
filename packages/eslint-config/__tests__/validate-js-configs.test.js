...
describe('Validate JS configs', () => {
  it('Validate eslint-config-re', async () => {
  ...
  it('Validate eslint-config-re/es5', async () => {
  ...
  it('Validate eslint-config-re/vue', async () => {
  ...
  it('Validate eslint-config-re/essential', async () => {
  ...
  it('Validate eslint-config-re/essential/es5', async () => {
  ...
  it('Validate eslint-config-re/essential/react', async () => {
  ...
  it('Validate eslint-config-re/essential/vue', async () => {
  ...
  it('Validate eslint-config-re/node', async () => {
