...
`encode-fe-lint` 是[re-spec 前端编码规范工程化](https://graham-sun.github.io/re-spec/)的配套 Lint 工具，可以为项目一键接入规范、一键扫描和修复规范问题，保障项目的编码规范和代码质量。
...
| Git 规范                                                          | [commitlint](https://commitlint.js.org/#/)                 | [commitlint-config-encode](hhttps://www.npmjs.com/package/markdownlint-config-encode)     |
