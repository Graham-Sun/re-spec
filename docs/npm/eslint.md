...
:::tip
re-spec JavaScript TypeScript Node 规范
:::
...
```json
{
  "extends": ["@sophiaa/eslint-config-re/react"]
}
```
...
```json
{
  "extends": ["@sophiaa/eslint-config-re/vue"]
}
```
...
```json
{
  "extends": ["@sophiaa/eslint-config-re/node"]
}
```
...
```json
{
  "extends": ["@sophiaa/eslint-config-re/typescript/react"]
}
```
...
```json
{
  "extends": ["@sophiaa/eslint-config-re/typescript/vue"]
}
```
...
```json
{
  "extends": ["@sophiaa/eslint-config-re/typescript/node"]
}
```
